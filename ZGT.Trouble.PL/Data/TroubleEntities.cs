...
namespace ZGT.Trouble.PL.Data
{
    ...
    {
        Guid[] PlayerGameId = new Guid[7]; //{ new Guid("c0e00542-a4bd-4088-b912-0dae885cb216"), Guid.NewGuid(), Guid.NewGuid() };
        Guid[] PlayerId = new Guid[4]; //{ new Guid("c0e00542-a4bd-4088-b912-0dae885cb215"), Guid.NewGuid(), Guid.NewGuid() };
        Guid[] GameId = new Guid[3]; //{ new Guid("c0e00542-a4bd-4088-b912-0dae885cb214"), Guid.NewGuid(), Guid.NewGuid() };
        ...
        {
            PlayerId[0] = new Guid("c0e00542-a4bd-4088-b912-0dae885cb215");
            for (int i = 1; i < PlayerId.Length; i++)
        ...
        modelBuilder.Entity<tblPlayer>(entity =>
            ...
            List<tblPlayer> Players = new List<tblPlayer>
            {
                ...
                new tblPlayer {Id = PlayerId[2], UserName = "Brian", Password = "maple", Email = "Brian@Brian", NumberOfWins = 0, DateJoined = DateTime.Now},
                new tblPlayer {Id = new Guid("11111111-1111-1111-1111-111111111111"), UserName = "Computer", Password = "12345", Email = "computer@computer", NumberOfWins = 0, DateJoined = DateTime.Now}
            };
        ...
        {
            GameId[0] = new Guid("c0e00542-a4bd-4088-b912-0dae885cb214");
        ...
        {
            PlayerGameId[0] = new Guid("c0e00542-a4bd-4088-b912-0dae885cb216");
            for (int i = 1; i < PlayerGameId.Length; i++)
            ...
            */
            ...
            modelBuilder.Entity<tblPlayerGame>(entity =>
            {
                ...
                entity.Property(e => e.PlayerColor).ValueGeneratedNever().IsRequired();
            ...
            {
                new tblPlayerGame {Id = PlayerGameId[0], PlayerId = PlayerId[0], GameId = GameId[0], PlayerColor = "y"},
                new tblPlayerGame {Id = PlayerGameId[1], PlayerId = PlayerId[1], GameId = GameId[1], PlayerColor = "y"},
                new tblPlayerGame {Id = PlayerGameId[2], PlayerId = PlayerId[2], GameId = GameId[2], PlayerColor = "y"},
                new tblPlayerGame {Id = PlayerGameId[3], PlayerId = new Guid("11111111-1111-1111-1111-111111111111"), GameId = GameId[0], PlayerColor = "b"},
                new tblPlayerGame {Id = PlayerGameId[4], PlayerId = new Guid("11111111-1111-1111-1111-111111111111"), GameId = GameId[0], PlayerColor = "r"},
                new tblPlayerGame {Id = PlayerGameId[5], PlayerId = new Guid("11111111-1111-1111-1111-111111111111"), GameId = GameId[0], PlayerColor = "g"},
                new tblPlayerGame {Id = PlayerGameId[6], PlayerId = new Guid("11111111-1111-1111-1111-111111111111"), GameId = GameId[1], PlayerColor = "b"},
            };
